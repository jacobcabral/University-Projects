...
class List:
    ...
    def __setitem__(self, i, value):
        ...
        blonde = deepcopy(value)
        self._values[i] = blonde
    ...
    def intersection(self, source1, source2):
        ...
        """
        for x in source1:
            if(x in source2 and x not in self._values):
        ...
        for x in source2:
            if(x in source1 and x not in self._values):
                self._values.append(x)
    ...
    def max(self):
        ...
        value = deepcopy(max(self._values))
    ...
    def min(self):
        ...
        value = deepcopy(min(self._values))
