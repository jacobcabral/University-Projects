...
class Sorted_List:
    ...
    def _binary_search(self, key):
        ...
        return low if self._is_valid_index(low) and self._values[low] == key else -1
    ...
    def combine(self, source1, source2):
        ...
        while(len(source1._values) > 0):
            ...
            if( len(self._values) == 0 ):
                ...
                i = 0
                inserted = False
                while(not inserted and i < len(self._values)):
    ...
    def find(self, key):
        ...
        return None if i == -1 else deepcopy(self._values[i])
    ...
    def intersection(self, source1, source2):
        ...
        for value in source2._values:
            if(value not in self._values and value in source1._values):
                if( len(self._values) == 0 ):
                    self._values.append( deepcopy(value) )
    ...
    def is_identical(self, target):
        ...
        while(i < len(self._values) and identical):
            identical = self._values[i] == target._values[i]
            i += 1
    ...
    def remove(self, key):
        ...
        """
        i = self._binary_search(key)
        return None if i == -1 else self._values.pop(i)
    ...
    def remove_many(self, key):
        ...
        """
        i = self._binary_search(key)
        while(self._is_valid_index(i) and self._values[i] == key):
            self._values.pop(i)
    ...
    def split_key(self, key):
        ...
        while(len(self._values) > 0 and self._values[0] < key):
            target1._values.append( self._values.pop(0) )
