...
class Hash_Set:
    ...
    def _find_slot(self, key):
        ...
        -------------------------------------------------------
        """
        return self._table[ hash(key) % self._slots ]
    ...
    def __contains__(self, key):
        ...
        -------------------------------------------------------
        """
        return key in self._find_slot(key)
    ...
    def _rehash(self):
        ...
        while(len(values) > 0):
            value = values.pop()
            self._find_slot(value).insert(value)
    ...
    def is_identical(self, target):
        ...
        -------------------------------------------------------
        """
        return self._table is target._table and \
            self._count == target._count and \
            self._slots == target._count and \
            self._LOAD_FACTOR == target._LOAD_FACTOR
    ...
    def debug(self):
        ...
        -------------------------------------------------------
        """
        print( "{:d} Slots".format(self._slots) )
        print()
        print("========================================")
